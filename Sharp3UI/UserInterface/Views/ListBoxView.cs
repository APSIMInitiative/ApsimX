namespace UserInterface.Views
{
    ...
    public class ListBoxView : ViewBase, IListBoxView
    {
        ...
        public ListBoxView(ViewBase owner) : base(owner)
        {
            ...
            Listview.ItemOrientation = Orientation.Horizontal;
            ...
            set
            {
                ...
                foreach (string val in value)
                {
                    ...
                    else if (isModels)
                    {
                        ...
                        string resourceNameForImage = "UserInterface.Resources.TreeViewImages." + addedModelDetails + text + ".png";
                        if (!MasterView.HasResource(resourceNameForImage))
                        {
                            resourceNameForImage = "UserInterface.Resources.TreeViewImages." + text + ".png";
                        }
                        if (MasterView.HasResource(resourceNameForImage))
                            image = new Gdk.Pixbuf(null, resourceNameForImage);
                        else
                            image = new Gdk.Pixbuf(null, "UserInterface.Resources.TreeViewImages.Simulations.png"); // It there something else we could use as a default?
                    }
        ...
        private string AddFileNameListItem(string fileName, ref Gdk.Pixbuf image)
        {
            ...
            if (image == null)
                image = new Gdk.Pixbuf(null, "UserInterface.Resources.apsim logo32.png");
            return result;
        }
