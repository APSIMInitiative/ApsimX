...
namespace Models.Core
{
    ...
    public class Configuration
    {
        ...
        /// <summary>A list of elapsed times for .apsimx files that were run last.</summary>
        public List<FileRunTime> RunTimes { get; set; }
        ...
        /// <summary>The registered users first name</summary>
        public string FirstName { get; set; }

        /// <summary>The registered users last name</summary>
        public string LastName { get; set; }

        /// <summary>The registered users organisation</summary>
        public string Organisation { get; set; }

        /// <summary>The registered users address1 line</summary>
        public string Address1 { get; set; }
        
        /// <summary>The registered users address2 line</summary>
        public string Address2 { get; set; }

        /// <summary>The registered users city</summary>
        public string City { get; set; }

        /// <summary>The registered users state</summary>
        public string State { get; set; }

        /// <summary>The registered users postcode</summary>
        public string Postcode { get; set; }

        /// <summary>The registered users country</summary>
        public string Country { get; set; }

        /// <summary>The registered users email</summary>
        ...
        /// <summary>
        /// A list of elapsed times for .apsimx files that were run last
        /// </summary>
        public class FileRunTime
        {
            /// <summary>File name of .apsimx file</summary>
            public string fileName;

            /// <summary>Elapsed time for .apsimx file (ms)</summary>
