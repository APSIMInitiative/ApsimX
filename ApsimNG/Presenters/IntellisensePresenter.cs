namespace UserInterface.Presenters
{
    ...
    public class IntellisensePresenter
    {
        ...
        public List<NeedContextItemsArgs.ContextItem> GetEvents(IModel model)
        {
            ...
            foreach (var publisher in Events.Publisher.FindAllPublishers(allModels))
            {
        ...
        /// <param name="properties">Return properties</param>
        /// <param name="methods"></param>
        /// <param name="publishedEvents">Return simulation events</param>
