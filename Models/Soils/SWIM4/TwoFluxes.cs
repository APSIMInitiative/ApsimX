...
{
    /// <summary>
    /// Calculates flux tables between two APSIM layers
    /// </summary>
    public static class TwoFluxes
    {
        ...
        public static FluxTable TwoTables(FluxTable ft1, SoilProps sp1, FluxTable ft2, SoilProps sp2)
        {
            ...
            for (ii = 1; ii <= n[i] - 1; ii++)
            {
                ...
                co = SoilTables.Cuco(hCuco, phiCuco); // get cubic coeffs
                v = h[ii, i] - h[k, j];
         ...
         */
            ...
            for (j = 1; j <= nft[2]; j++)
            {
                ...
                {
                    phico2[k] = phif[ip, 2];
                    double[] co2co = SoilTables.Cuco(new double[5] { 0, phif[ip, 2], phif[ip + 1, 2], phif[ip + 2, 2], phif[ip + 3, 2] },
            ...
            for (i = 1; i <= nft[1]; i++) //step through top phis
            {
                ...
                {
                    phico1[k] = phif[ip, 1];
                    co1M.SetRow(k, SoilTables.Cuco(new double[5] { 0, phif[ip, 1], phif[ip + 1, 1], phif[ip + 2, 1], phif[ip + 3, 1] },
        ...
        /// <summary>
        /// Framework required for testing. Not for general use.
        /// </summary>
        /// <param name="phia"></param>
        /// <param name="nft"></param>
        /// <param name="phie"></param>
        /// <param name="Ks"></param>
        /// <param name="phif"></param>
        /// <param name="qf"></param>
        /// <param name="he"></param>
        /// <param name="coq"></param>
        /// <param name="co1"></param>
        /// <param name="nco1"></param>
        /// <param name="phico1"></param>
        /// <param name="phi1max"></param>
        /// <param name="phii"></param>
        /// <param name="co2"></param>
        /// <param name="phico2"></param>
        /// <param name="j"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return i where x is between xa(i) and xa(i+1)
        /// </summary>
        /// <param name="x"></param>
        /// <param name="xa"></param>
        /// <returns></returns>
