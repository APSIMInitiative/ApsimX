...
copy /y "%apsimx%\Bin\Models.exe" "%apsimx%\Docker\runtests\APSIM.PerformanceTests.Collector\"
copy /y "%apsimx%\Bin\APSIM.Shared.dll" "%apsimx%\Docker\runtests\APSIM.PerformanceTests.Collector\"
