...
namespace APSIM.Documentation.Models.Types
{
    ...
    public class DocLeafCohortParameters : DocGeneric
    {
        ...
        public override List<ITag> Document(int none = 0)
        {
            ...
            laiTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.GrowthDuration as IModel));
            ...
            laiTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.MaxArea as IModel));
            ...
            laiTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.LagDuration as IModel));
            laiTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.SenescenceDuration as IModel));
            ...
            laiTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.ShadeInducedSenescenceRate as IModel));
            ...
            stressTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.CellDivisionStress as IModel));
            ...
            stressTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.ExpansionStress as IModel));
            ...
            dmDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.SpecificLeafAreaMax as IModel));
            dmDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.SpecificLeafAreaMin as IModel));
            ...
            dmDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.StructuralFraction as IModel));
            ...
            nDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.MinimumNConc as IModel));
            ...
            nDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.CriticalNConc as IModel));
            ...
            nDemandTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.MaximumNConc as IModel));
            ...
            dmSupplyTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.DMReallocationFactor as IModel));
            ...
            dmSupplyTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.DMRetranslocationFactor as IModel));
            ...
            nSupplyTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.NReallocationFactor as IModel));
            ...
            nSupplyTags.AddRange(AutoDocumentation.DocumentModel(leafCohortParameters.NRetranslocationFactor as IModel));
            section.Add(new Section("Nitrogen supply", nSupplyTags));

            // Document Constants
            var constantTags = new List<ITag>();
            foreach (var constant in leafCohortParameters.Node.FindChildren<Constant>())
