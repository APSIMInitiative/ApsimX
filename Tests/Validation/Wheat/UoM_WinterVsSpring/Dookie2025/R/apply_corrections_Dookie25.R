...
#' @param ref_date Character. The reference start date (e.g., "01-01-2025").
#'
#' @return The cleaned nested tibble with corrected dates.
#'
#' @importFrom dplyr mutate
#' @importFrom purrr map2
#' @importFrom lubridate dmy ymd year parse_date_time
#' @export
apply_corrections_Dookie25 <- function(df_tbl, ref_date) {
