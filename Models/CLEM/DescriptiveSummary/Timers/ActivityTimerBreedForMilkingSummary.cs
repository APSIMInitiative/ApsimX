...
public class ActivityTimerBreedForMilkingSummary : TimerSummaryBase<ActivityTimerBreedForMilking>
{
    ...
    public override void BuildSummary()
    {
        ...
        {
            htmlWriter.Write($"{generator.DisplaySummaryValueSnippet(ModelTyped.RestMonths, spanClass: "setvalueextra", warnZero: true)} {generator.DisplayPlural(ModelTyped.RestMonths, "month")} rest after lactation");
        }
