...
{
    /// <summary>
    /// This stores the parameters relating to RuminantActivityGrowPF for a ruminant Type (CM - metabolism parameters)
    ...
    [Description("Ruminant metabolism (CM) parameters for GrowPF approach")]
