...
# load Justin's function (FIXME: not used yet, reading from output csv file)
...
# FIXME: can I call myDb as simData ?
...
# get date sorted
myDb$Date <- dmy(myDb$Clock.Today)
...
myDb$Name <- gsub(" ", "", myDb$SimName, fixed = TRUE)
