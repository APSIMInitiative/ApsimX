...
docker run -m 16g --cpu-count %NUMBER_OF_PROCESSORS% --cpu-percent 100 -e "NUMBER_OF_PROCESSORS=%NUMBER_OF_PROCESSORS%" -v %cd%\ApsimX:C:\ApsimX -v %cd%\APSIM.Shared:C:\APSIM.Shared createinstallation %1
