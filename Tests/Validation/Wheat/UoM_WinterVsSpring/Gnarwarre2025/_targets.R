...
list(
  ...
  # 2. THE SANITIZER: Handles duplicate grain columns and unit scaling
  tar_target(
    name = df_obs_corrected,
    command = apply_corrections_Gna25(df_obs_renamed) 
  ),
  ...
  # --- THE NEW PHENOLOGY INTEGRITY BLOCK ---
  tar_target(
