...
list(
  ...
  tar_target(
    ...
    list(
      ...
      file_rawData_excel          = "GrassPatch2024/Observed.xlsx", # raw observed data (pre-defined file name),
      file_workData_excel         = "GrassPatch2024_Observed.xlsx", # raw observed data (pre-defined file name)
  ...
  # read observations
  tar_target(file_obs, read_excel_observed(file.path(config$folder_thisScript, 
