...
{
    [TestFixture]
    public class C4MaizeCropParameterGeneratorTests
    {
        [Test]
        public void Generate_DefaultParams_ReturnsDefaultsValue()
        {
            // Arrange & Act
            var cropParams = C4MaizeCropParameterGenerator.Generate();
            ...
            Assert.That(cropParams.Pathway.MaxElectronTransportSLNRatio, Is.EqualTo(4.03));
            Assert.That(cropParams.Pathway.MaxPEPcActivitySLNRatio, Is.EqualTo(1.88));
            Assert.That(cropParams.Pathway.MesophyllCO2ConductanceSLNRatio, Is.EqualTo(0.0153));
            ...
            Assert.That(cropParams.Pathway.ElectronTransportRateParams.C, Is.EqualTo(0.674383));
            ...
            Assert.That(cropParams.Pathway.EpsilonParams.TOpt, Is.EqualTo(35.311));
            Assert.That(cropParams.Pathway.EpsilonParams.TMax, Is.EqualTo(50));
            Assert.That(cropParams.Pathway.EpsilonParams.C, Is.EqualTo(0.870928));
            Assert.That(cropParams.Pathway.EpsilonParams.Beta, Is.EqualTo(0.486));
            ...
            Assert.That(cropParams.Pathway.EpsilonAt25, Is.EqualTo(0.254));
