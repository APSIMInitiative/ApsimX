...
{
	/// <summary>
	/// This stores the parameters for a Pasture type and holds values in the store
	/// </summary>
	[Serializable]
	...
	public class GrazeFoodStoreType : Model, IFeedType
	{
		...
		/// Detach pasture rate
		/// </summary>
		[Description("Detach pasture rate")]
		public double DetachPasture { get; set; }

		/// <summary>
		/// Detach carry over rate
		/// </summary>
		[Description("Detach carryover rate")]
		public double DetachCarryOver { get; set; }
		...
		{
			// Called if activity removes food directly from Pasture (no Feed Arbitrator used)
			// Remove requested amount from all pools as proportion pool amount of whole pasture
