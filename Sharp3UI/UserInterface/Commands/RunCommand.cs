    ...
    class RunCommand : ICommand
    {
        ...
        private void OnAllJobsCompleted(object sender, Runner.AllJobsCompletedArgs e)
        {
            ...
            if (!Configuration.Settings.Muted)
            {
                ...
                //    else
                //        player.Stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.Sounds.Fail.wav");
                //}
                //else
                //{
                ...
                //        player.SoundLocation = Configuration.Settings.SimulationCompleteWithErrorWavFileName;
                //    else
                //        player.Stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.Sounds.Success.wav");
                //}
                //
                //player.Play();
            }
