...
namespace Models.AgPasture
{
    ...
    public class PastureBelowGroundOrgan
    {
                                       ...
                                       double myRootDistributionExponent)
        {
            ...
            SoilNitrogen = Apsim.Find(soil, typeof(INutrient)) as INutrient;
        ...
        private void PlantAvailableSoilNDefaultAPSIM(ZoneWaterAndN myZone)
        {
            ...
            for (int layer = 0; layer <= BottomLayer; layer++)
            {
                ...
                potAvailableN = Math.Pow(myZone.PlantAvailableNH4N[layer] * layerFrac, 2.0) * swFac * bdFac * KNH4;
                ...
                potAvailableN = Math.Pow(myZone.PlantAvailableNO3N[layer] * layerFrac, 2.0) * swFac * bdFac * KNO3;
