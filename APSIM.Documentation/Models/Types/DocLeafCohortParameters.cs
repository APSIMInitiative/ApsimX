...
namespace APSIM.Documentation.Models.Types
{
    ...
    public class DocLeafCohortParameters : DocGeneric
    {
        ...
        public override List<ITag> Document(int heading = 0)
        {
            ...
            laiTags.AddRange(AutoDocumentation.Document(leafCohortParameters.GrowthDuration));
            ...
            laiTags.AddRange(AutoDocumentation.Document(leafCohortParameters.MaxArea));
            ...
            laiTags.AddRange(AutoDocumentation.Document(leafCohortParameters.LagDuration));
            ...
            stressTags.AddRange(AutoDocumentation.Document(leafCohortParameters.CellDivisionStress));
            ...
            dmDemandTags.AddRange(AutoDocumentation.Document(leafCohortParameters.SpecificLeafAreaMax));
            dmDemandTags.AddRange(AutoDocumentation.Document(leafCohortParameters.SpecificLeafAreaMin));
            ...
            nDemandTags.AddRange(AutoDocumentation.Document(leafCohortParameters.MinimumNConc));
