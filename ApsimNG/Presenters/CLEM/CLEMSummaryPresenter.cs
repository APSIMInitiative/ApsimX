...
namespace UserInterface.Presenters
{
    ...
    public class CLEMSummaryPresenter : IPresenter, IRefreshPresenter
    {
        ...
        public void Attach(object model, object view, ExplorerPresenter explorerPresenter)
        {
            ...
            //summaryGenerator.GenerateSummaryForComponentAndChildren(model as IModel, Path.Combine(Path.GetDirectoryName(explorer.ApsimXFile.FileName), "CurrentDescriptiveSummary.md"), format: DescriptiveSummaryFormat.Markdown);
            //summaryGenerator.GenerateSummaryForComponentAndChildren(model as IModel, Path.Combine(Path.GetDirectoryName(explorer.ApsimXFile.FileName), "CurrentDescriptiveSummary.txt"), format: DescriptiveSummaryFormat.Text);
        }
