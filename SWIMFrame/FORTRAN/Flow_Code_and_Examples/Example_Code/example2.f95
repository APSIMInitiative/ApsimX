...
program example2
 ...
 ! rate is 0.05 cm/h throughout. There is vapour flow, but no sink term and no
 ! solute transport. It differs from example 1 in calling solve every day. This
 ! increases the number of steps, especially when solve could take steps > 1 day
 ! - e.g. for the stepsize control dSmax set to 0.05 the number increases from
 ! 98 to 186.
 ...
 open (unit=2,iostat=j,file="example2.out",status="replace",position="rewind")
