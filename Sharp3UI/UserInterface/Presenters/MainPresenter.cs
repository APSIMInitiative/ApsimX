namespace UserInterface.Presenters
{
    ...
    public class MainPresenter
    {
        ...
        public void Attach(object view, string[] commandLineArguments)
        {
            ...
            //this.view.Show();
            if (Configuration.Settings.StatusPanelHeight > 0.5 * this.view.WindowSize.Height)
                this.view.StatusPanelHeight = 20;
            else
                this.view.StatusPanelHeight = Configuration.Settings.StatusPanelHeight;
        ...
        private void PopulateStartPage(IListButtonView startPage)
        {
            ...
            startPage.AddButton(
                                "Open APSIM File",
                                          new Gtk.Image(null, "UserInterface.Resources.Toolboxes.OpenFile.png"),
                                          this.OnOpenApsimXFile);

            startPage.AddButton(
                                "Open an example",
                                          new Gtk.Image(null, "UserInterface.Resources.Toolboxes.OpenExample.png"),
                                          this.OnExample);

            startPage.AddButton(
                                "Standard toolbox",
                                          new Gtk.Image(null, "UserInterface.Resources.Toolboxes.Toolbox.png"),
            ...
            startPage.AddButton(
                                "Import old .apsim file",
                                          new Gtk.Image(null, "UserInterface.Resources.Toolboxes.Import.png"),
                                          this.OnImport);

            startPage.AddButton(
                                "Upgrade",
                                        new Gtk.Image(null, "UserInterface.Resources.MenuImages.Upgrade.png"),
                                        this.OnUpgrade);

            startPage.AddButton(
                                "View Cloud Jobs",
                                        new Gtk.Image(null, "UserInterface.Resources.Cloud.png"),
            ...
            startPage.AddButtonWithMenu(
                                        "Settings",
                                        new Gtk.Image(null, "UserInterface.Resources.MenuImages.Settings.png"));
            ...
            startPage.AddButtonToMenu(
                                      "Settings",
                                      "Toggle Theme",
                                      new Gtk.Image(null, Configuration.Settings.DarkTheme ? "UserInterface.Resources.MenuImages.Sun.png" : "UserInterface.Resources.MenuImages.Moon.png"),
                                      OnToggleTheme);

            startPage.AddButton(
                            "Help",
                            new Gtk.Image(null, "UserInterface.Resources.MenuImages.Help.png"),
                            this.OnHelp);
