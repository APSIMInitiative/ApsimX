namespace Models.PMF.Organs
{
    ...
    public class GenericOrgan : Model, IOrgan, IArbitration, ICustomDocumentation, IRemovableBiomass
    {
        ...
        public double BiomassToleranceValue = 0.0000000001; 
        ...
        protected virtual void SetNSupply(object sender, EventArgs e)
        {
            ...
            NSupply.Retranslocation = RetranslocateNitrogen.CalculateN(this);
        ...
        public virtual void SetNitrogenAllocation(BiomassAllocationType nitrogen)
        {
            ...
            {
                RetranslocateNitrogen.AllocateN(this, nitrogen);
            }
            else
            {
                // Retranslocation
                ...
                Allocated.MetabolicN -= (nitrogen.Retranslocation - StorageNRetranslocation);
            }
