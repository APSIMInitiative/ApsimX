...
namespace Models.AgPasture1
{
    ...
    public class Sward : Model, ICrop
    {
        ...
        /// <summary>Gets or sets the data about the sward's canopy, used by MicroClimate</summary>
        ...
        /// <summary>Reference to the species present in the sward.</summary>
        /// <value>Pature species.</value>
        [XmlIgnore]
       ...
       // - Parameters that are set via user interface  ---------------------------------------------------------------
        ...
        /// <summary>Gets the shoot-root ration of N content.</summary>
        /// <value>The ration between above and below ground N content.</value>
        ...
        /// <summary>Gets the average light extintion coefficient.</summary>
        /// <value>The light extintion coefficient.</value>
        ...
        {
            get { return mySward.Sum(mySpecies => mySpecies.HerbageDigestibility * mySpecies.StandingWt) / StandingWt; }
        }
        ...
        /// <summary>sward root depth (maximumn depth of all species)</summary>
