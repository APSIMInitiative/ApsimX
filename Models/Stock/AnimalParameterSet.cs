namespace Models.GrazPlan
{
    ...
    public class AnimalParameterSet : Model
    {
        ...
        /// <returns></returns>
        public AnimalParameterSet(string nameOfNewGenotype, AnimalParameterSet damBreed, AnimalParameterSet sireBreed, double damProportion, double sireProportion)
        {
        ...
        public AnimalParameterSet(string name, string animalTypeString, List<PropertyReplacement> parameters)
        {
            for (int i = 0; i < ConceiveSigs.Length; i++)
                ConceiveSigs[i] = new double[2];
            Name = name;
        ...
        private void SetParentage(AnimalParameterSet parentBreed, double proportion)
        {
