...
namespace APSIM.Documentation.Models.Types
{
    ...
    /// </summary>
    public class DocBiomassArbitrator : DocGeneric
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocBiomassArbitrator" /> class.
        /// </summary>
        public DocBiomassArbitrator(IModel model): base(model) {}
