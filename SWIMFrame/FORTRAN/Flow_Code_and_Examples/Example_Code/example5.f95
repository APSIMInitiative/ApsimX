...
program example5
 ...
 ! no sink term and no solute transport. However, there is continuous surface
 ! evaporation and instantaneous water extraction by roots at the end of every
 ! day, calculated in the main program using module "roots".
 ...
 integer::il,j,jt(n),sidx(n),nsteps
 ...
 open (unit=2,iostat=j,file="example5.out",status="replace",position="rewind")
