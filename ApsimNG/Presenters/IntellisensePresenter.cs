...
namespace UserInterface.Presenters
{
    ...
    public class IntellisensePresenter
    {
        ...
        public bool GenerateGridCompletions(string cellContents, int offset, IModel model, bool controlSpace = false)
        {
            ...
            List<NeedContextItemsArgs.ContextItem> completionOptions = NeedContextItemsArgs.ExamineModelForNames(model, objectName, true, true, false);
            view.Populate(completionOptions);
            return completionOptions.Any();
        }
        ...
        /// <param name="controlSpace">True iff this intellisense request was generated by the user pressing control + space.</param>
        /// <returns>True if any completion options are found. False otherwise.</returns>
        private bool GenerateScriptCompletions(string code, int offset, bool controlSpace = false)
        {
