...
program example9
 ...
 ! module "sinks" using module "roots". Drippers and drains are in the same
 ! layer, so 3 water extraction streams are used, one for roots, one for
 ! drippers and one for drains.
 ...
 open (unit=2,iostat=j,file="example9.out",status="replace",position="rewind")
 ...
 idrip=4; idrn=4 ! drippers in layer 4, drain in layer 4
