...
namespace Models.Functions
{
    ...
    public class BellCurveFunction : Model, IFunction
    {
        ...
        [Link(ByName = true)] IFunction LargestLeafPosition = null; // Node position where the largest leaf occurs (e.g. 10 is the 10th leaf from bottom to top)
        /// <summary>The area maximum</summary>
        [Link(ByName = true)] IFunction AreaMax = null;             // Area of the largest leaf of a plant (mm2)
        /// <summary>The breadth</summary>
        [Link(ByName = true)] IFunction Breadth = null;
        /// <summary>The skewness</summary>
        [Link(ByName = true)] IFunction Skewness = null;
