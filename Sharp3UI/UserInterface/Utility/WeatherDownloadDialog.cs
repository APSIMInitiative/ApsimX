...
namespace Utility
{
    ...
    class WeatherDownloadDialog
    {
        ...
        {
            Builder builder = ViewBase.BuilderFromResource("UserInterface.Resources.Glade.WeatherDownload.glade");
        ...
        public string GetPatchPoint()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    tree.Model = list;
                    md.ContentArea.PackStart(tree, true, true, 5);
                    md.ContentArea.ShowAll();
