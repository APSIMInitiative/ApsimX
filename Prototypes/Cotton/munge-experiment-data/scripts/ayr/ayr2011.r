...
# Phenology 
# ---------
s1_table1 <- read_xls(path, sheet = "2011", range = "A21:Q24")
s2_table1 <- read_xls(path, sheet = "2011", range = "A37:Q40")
...
phenology <- phenology %>% mutate(year ="2011")
phenology_2011 <- phenology %>% select(year, variety, sowing, event_date, DAS, event_name) 
...
harvest <- harvest %>% mutate(year = "2011")
harvest_2011 <- harvest %>% select(year, variety, sowing, date, everything())



# Weather
# -------
weather <- read_xls(path, sheet = "2011", range = "A85:E297")
...
s1_square_no <- read_xls(path, sheet = "2011", range = "S10:W18")
s2_square_no <- read_xls(path, sheet = "2011", range = "S21:W28")

s1_square_mass <- read_xls(path, sheet = "2011", range = "Z10:AD18")
s2_square_mass <- read_xls(path, sheet = "2011", range = "Z21:AD28")

s1_green_boll_no <- read_xls(path, sheet = "2011", range = "AG10:AK18")
s2_green_boll_no <- read_xls(path, sheet = "2011", range = "AG21:AK28")

s1_green_boll_mass <- read_xls(path, sheet = "2011", range = "AN10:AR18")
s2_green_boll_mass <- read_xls(path, sheet = "2011", range = "AN21:AR28")

s1_open_boll_no <- read_xls(path, sheet = "2011", range = "AU10:AY18")
s2_open_boll_no <- read_xls(path, sheet = "2011", range = "AU21:AY28")

s1_open_boll_mass <- read_xls(path, sheet = "2011", range = "BB10:BF18")
s2_open_boll_mass <- read_xls(path, sheet = "2011", range = "BB21:BF28")

s1_unharvest_boll_no <- read_xls(path, sheet = "2011", range = "BI10:BM18")
s2_unharvest_boll_no <- read_xls(path, sheet = "2011", range = "BI21:BM28")

s1_unharvest_boll_mass <- read_xls(path, sheet = "2011", range = "BP10:BT18")
s2_unharvest_boll_mass <- read_xls(path, sheet = "2011", range = "BP21:BT28")

s1_total_retention <- read_xls(path, sheet = "2011", range = "BW10:CA18")
s2_total_retention <- read_xls(path, sheet = "2011", range = "BW21:CA28")



# below first section

s1_leaf_area <- read_xls(path, sheet = "2011", range = "S34:W42")
s2_leaf_area <- read_xls(path, sheet = "2011", range = "S45:W52")

s1_leaf_mass <- read_xls(path, sheet = "2011", range = "Z34:AD42")
s2_leaf_mass <- read_xls(path, sheet = "2011", range = "Z45:AD52")

s1_stem_mass <- read_xls(path, sheet = "2011", range = "AG34:AK42")
s2_stem_mass <- read_xls(path, sheet = "2011", range = "AG45:AK52")

# this table has problems with its dates column. 
s1_lai <- read_xls(path, sheet = "2011", range = "AN34:AR42")
s2_lai <- read_xls(path, sheet = "2011", range = "AN45:AR52")


# DO NOT JOIN THESE

s1_light_interception <- read_xls(path, sheet = "2011", range = "AU34:AY41") # missing a row
s2_light_interception <- read_xls(path, sheet = "2011", range = "AU45:AY51")

#this isn't in 2008 dataset
s1_open_boll_percent <- read_xls(path, sheet = "2011", range = "BB34:BF42")
s2_open_boll_percent <- read_xls(path, sheet = "2011", range = "BB46:BF52")

#this isn't in 2008 dataset
s1_mean_boll_weight <- read_xls(path, sheet = "2011", range = "BI34:BM42")
s2_mean_boll_weight <- read_xls(path, sheet = "2011", range = "BI46:BM52")

s1_nodes_over_time <- read_xls(path, sheet = "2011", range = "BP34:BT43")
s2_nodes_over_time <- read_xls(path, sheet = "2011", range = "BP46:BT53")
...
# dates are wrong for the leaf_area and lai date column for s1
s1_leaf_area[1] <- s1_stem_mass[1]
s1_lai[1] <- s1_stem_mass[1]
...
plant_2011 <- full_join(square_no, square_mass, by = c("sowing", "variety", "date", "DAS")) %>% 
...
plant_2011 <- plant_2011 %>% mutate(year = "2011")

plant_2011 <- plant_2011 %>% select(year, variety, sowing, date, DAS, everything())
...
light_interception <- light_interception %>% mutate(year = "2011")

light_interception_2011 <- light_interception %>% select(year, variety, sowing, date, DAS, everything())
...
nodes_over_time <- nodes_over_time %>% mutate(year = "2011")

nodes_over_time_2011 <- nodes_over_time %>% select(year, variety, sowing, date, DAS, everything())
...
bolls <- bolls %>% mutate(year = "2011")

bolls_2011 <- bolls %>% select(year, variety, sowing, date, DAS, everything())
