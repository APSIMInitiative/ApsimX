namespace UnitTests.Core
{
    ...
    class ScopeTests
    {
        ...
        /// </summary>
        [Test]
        public void EnsureFindAllDoesNotReturnDisabledModels()
        {
            var modelWithParentLink = new ModelWithParentLink();
            ...
            Assert.AreEqual(inScopeOfLeaf1[3].Name, "zone1");
            Assert.AreEqual(inScopeOfLeaf1[4].Name, "Soil");
            Assert.AreEqual(inScopeOfLeaf1[5].Name, "Simulation");
            Assert.AreEqual(inScopeOfLeaf1[6].Name, "Clock");
            Assert.AreEqual(inScopeOfLeaf1[7].Name, "MockSummary");
