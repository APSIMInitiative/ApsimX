...
namespace Models.Core
{
    ...
    public class Model : IModel
    {
        ...
        [XmlElement(typeof(Models.WholeFarm.Activities.ActivityTimerCropHarvest))]
        [XmlElement(typeof(Models.WholeFarm.Activities.ActivityTimerDateRange))]
		[XmlElement(typeof(Models.WholeFarm.Activities.ActivityTimerInterval))]
		[XmlElement(typeof(Models.WholeFarm.Activities.ActivityTimerMonthRange))]
        ...
        [XmlElement(typeof(Models.WholeFarm.Activities.CropActivityFee))]
        [XmlElement(typeof(Models.WholeFarm.Activities.CropActivityManageCrop))]
        [XmlElement(typeof(Models.WholeFarm.Activities.CropActivityManageProduct))]
        [XmlElement(typeof(Models.WholeFarm.Activities.CropActivityTask))]
		...
		[XmlElement(typeof(Models.WholeFarm.Groupings.LabourFilterGroupDefine))]
		[XmlElement(typeof(Models.WholeFarm.Groupings.LabourFilterGroupSpecified))]
        [XmlElement(typeof(Models.WholeFarm.Groupings.LabourFilterGroupUnit))]
        ...
        [XmlElement(typeof(Models.WholeFarm.Activities.ResourceActivitySell))]
		...
		[XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityCollectManureAll))]
		[XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityCollectManurePaddock))]
		...
		[XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityMilking))]
		...
		[XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityPredictiveStockingENSO))]
        ...
        [XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityWean))]
		...
		[XmlElement(typeof(Models.WholeFarm.Activities.RuminantActivityFee))]
