...
namespace Models.Core
{
    ...
    public class Model : IModel
    {
        ...
        [XmlElement(typeof(Soils.Nutrients.Nutrient))]
        [XmlElement(typeof(Soils.Nutrients.NutrientPool))]
        [XmlElement(typeof(Soils.Nutrients.CarbonFlow))]
        [XmlElement(typeof(Soils.Nutrients.NFlow))]
        [XmlElement(typeof(Soils.Nutrients.Solute))]
        [XmlElement(typeof(Soils.Nutrients.Chloride))]
