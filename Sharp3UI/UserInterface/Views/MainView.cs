namespace UserInterface.Views
{
    ...
    public class MainView : ViewBase, IMainView
    {
        ...
        /// Dark theme icon.
        /// </summary>
        private static readonly Gtk.Image darkThemeIcon = new Gtk.Image(null, "UserInterface.Resources.MenuImages.Moon.png");

        /// <summary>
        /// Default theme Icon.
        /// </summary>
        private static readonly Gtk.Image defaultThemeIcon = new Gtk.Image(null, "UserInterface.Resources.MenuImages.Sun.png");
        ...
        public MainView(ViewBase owner = null) : base(owner)
        {
            MasterView = this;
            numberOfButtons = 0;
            Builder builder = BuilderFromResource("UserInterface.Resources.Glade.MainView.glade");
            ...
            mainWidget = window1;
            window1.Icon = new Gdk.Pixbuf(null, "UserInterface.Resources.apsim logo32.png");
            ...
            stopButton.Image = new Gtk.Image(new Gdk.Pixbuf(null, "UserInterface.Resources.MenuImages.Delete.png", 12, 12));
        ...
        public void AddTab(string text, Gtk.Image image, Widget control, bool onLeftTabControl)
        {
            ...
            Gtk.Image closeImg = new Gtk.Image(new Gdk.Pixbuf(null, "UserInterface.Resources.Close.png", 12, 12));

            closeBtn.Image = closeImg;
            closeBtn.Relief = ReliefStyle.None;
            closeBtn.Clicked += OnCloseBtnClick;

            // fixme - we previously called hbox.PackStart(tabLabel);
            // need to check that these extra args are the correct defaults.
        ...
        public Widget LabelWithIcon(string text, string icon)
        {
            ...
            {
                string nameForImage = "UserInterface.Resources.TreeViewImages." + text + ".png";
                if (HasResource(nameForImage))
                    icon = nameForImage;
                else
                    icon = "UserInterface.Resources.apsim logo32.png";
            }
        ...
        public void RefreshTheme()
        {
            if (Utility.Configuration.Settings.DarkTheme)
            {
                ...
                using (Stream rcStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.dark.gtkrc"))
                {
