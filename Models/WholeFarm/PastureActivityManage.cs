...
namespace Models.WholeFarm
{
	...
	/// <summary>This activity provides a pasture based on land unit, area and pasture types</summary>
	...
	public class PastureActivityManage: Model
	{
		...
		private void OnSimulationCommencing(object sender, EventArgs e)
		{
			...
			FeedType = Resources.GetResourceItem("Pasture", FeedTypeName) as GrazeFoodStoreType;
		...
		private void OnWFAgeResources(object sender, EventArgs e)
		{
			...
			foreach (var pool in FeedType.Pools)
			{
				...
				double detach = FeedType.DetachCarryOver;
				if (pool.Age<12)
				{
					detach = FeedType.DetachPasture;
					pool.Age++;
				}
