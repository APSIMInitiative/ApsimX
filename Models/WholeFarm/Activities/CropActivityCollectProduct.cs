...
namespace Models.WholeFarm.Activities
{
    ...
    [ValidParent(ParentType = typeof(CropActivityManage))]
    public class CropActivityCollectProduct: WFActivityBase, IValidatableObject
    {
        [Link]
        Clock Clock = null;
        [Link]
        ...
        private void OnSimulationCommencing(object sender, EventArgs e)
        {
            ...
            LinkedResourceItem = Resources.GetResourceItem(this, Store.GetType(), StoreItemName, OnMissingResourceActionTypes.ReportErrorAndStop, OnMissingResourceActionTypes.ReportErrorAndStop) as IResourceType;
