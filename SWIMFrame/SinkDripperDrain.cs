...
namespace SWIMFrame
{
    ...
    */
    public class SinkDripperDrain : ISink
    {
        ...
        public void Wsinks(double t, int[] isat, double[] var, double[] he, ref double[,] qwex, ref double[,] qwexd)
        {
            if (drip)
        ...
        public void Ssinks(double t, double ti, double tf, int isol, double[,] dwex, double[] c, ref double[,] qsex, ref double[,] qsexd)
        {
