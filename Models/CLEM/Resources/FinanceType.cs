    ...
    public class FinanceType : CLEMResourceTypeBase, IResourceWithTransactionType, IResourceType
    {
        ...
        public new void Remove(ResourceRequest request)
        {
            ...
            if (request.MarketTransactionMultiplier > 0 && EquivalentMarketStore != null)
                (EquivalentMarketStore as FinanceType).Add(amountRemoved * request.MarketTransactionMultiplier, request.ActivityModel, (request.RelatesToResource!=""?request.RelatesToResource: this.NameWithParent),  "Farm purchases");
