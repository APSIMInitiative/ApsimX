...
namespace Models.Utilities
{
    ...
    public class R
    {
        ...
        public string InstallPackage(string package)
        {
            ...
            string packagePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
                                              "ApsimInitiative",
                                              "ApsimX").Replace("\\", "/");
            var stdout = Run(rFileName, package + " " + packagePath, throwOnError: true);
            return stdout;
        }
