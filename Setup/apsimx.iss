...
Source: ..\DeploymentSupport\Windows\Bin\*.dll; DestDir: {app}\Bin; Flags: ignoreversion; Check: not Is64BitInstallMode
...
Source: ..\ApsimNG\Assemblies\MonoMac.dll; DestDir: {app}\Bin; Flags: ignoreversion;
