...
# NOTE: We need Obs data for phenology stages 6 and 8 to continue this one
...
list(
  ...
  tar_target(
    ...
    list(
      ...
      file_workData_excel         = "Gnarwarre2025_Observed.xlsx", # raw observed data (pre-defined file name)
      ...
      file_name_input_pheno       = "Gnarwarre2025_PhenoDatesInput.csv",
      file_name_input_haun        = "Gnarwarre2025_HaunStagesInput.csv"
        )),
