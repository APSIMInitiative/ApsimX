...
namespace Models.CLEM.DescriptiveSummary
{
    ...
    public class RuminantActivityEntericCH4CharmleySummary : RuminantActivitySummaryBase<RuminantActivityEntericCH4Charmley>
    {
        ...
        {
            generator.AddBlockWithText("activityentry", "Produces enteric methane emissions using the Charmley et al. method and places emissions into the greenhouse gas store(s) with AutoAllocate on.");
