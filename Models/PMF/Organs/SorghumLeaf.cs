...
namespace Models.PMF.Organs
{
    ...
    public class SorghumLeaf : Model, IHasWaterDemand, IOrgan, IArbitration, IOrganDamage, ICanopy, IHasDamageableBiomass
    {
        ...
        private void OnDoPotentialPlantGrowth(object sender, EventArgs e)
        {
            ...
            if (leafInitialised && flag == 0)
            {
                flag = 1;
            }
            else if (leafInitialised && flag > 0)
            {
                flag = 2;
        ...
        private void OnDoActualPlantGrowth(object sender, EventArgs e)
        {
            ...
            // TODO Revisit.
            int flagLeaf = 6; //= phenology.StartStagePhaseIndex("FlagLeaf");

            if (phenology.Stage >= flagLeaf)
            {
