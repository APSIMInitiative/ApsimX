...
namespace Models.Core
{
    ...
    public class Model : IModel
    {
        ...
        [XmlElement(typeof(Models.PMF.Development.BBCH))]
        [XmlElement(typeof(Models.PMF.Development.Phenology))]
        [XmlElement(typeof(Models.PMF.Development.EmergingPhase))]
        [XmlElement(typeof(Models.PMF.Development.EndPhase))]
        [XmlElement(typeof(Models.PMF.Development.ExpressionPhase))]
        [XmlElement(typeof(Models.PMF.Development.GenericPhase))]
        [XmlElement(typeof(Models.PMF.Development.GerminatingPhase))]
        [XmlElement(typeof(Models.PMF.Development.GotoPhase))]
        [XmlElement(typeof(Models.PMF.Development.LeafAppearancePhase))]
        [XmlElement(typeof(Models.PMF.Development.LeafDeathPhase))]
        [XmlElement(typeof(Models.PMF.Development.MolecularPhenology))]
        [XmlElement(typeof(Models.PMF.Development.NodeNumberPhase))]
        [XmlElement(typeof(Models.PMF.Development.PhaseSetFunction))]
        [XmlElement(typeof(Models.PMF.Development.Vernalisation))]
        [XmlElement(typeof(Models.PMF.Development.VernalisationC))]
        [XmlElement(typeof(Models.PMF.Development.VernalisationCW))]
        [XmlElement(typeof(Models.PMF.Development.QualitativePPEffect))]
        [XmlElement(typeof(Models.PMF.Development.ZadokPMF))]
        [XmlElement(typeof(Models.PMF.Development.BuddingPhase))]
