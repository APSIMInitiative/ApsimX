...
namespace Models.Functions
{
    ...
    public class DailyMeanVPDFunction : Model, IFunction, ICustomDocumentation
    {
        ...
        [Description("MaximumVPDWeighting")]
        public double MaximumVPDWeighting { get; set; } = 0.66;
        ...
        public double Value(int arrayIndex = -1)
        {
            ...
            double meanVPD = MaximumVPDWeighting * VPDmaxt + (1 - MaximumVPDWeighting) * VPDmint;
        ...
        public void Document(List<AutoDocumentation.ITag> tags, int headingLevel, int indent)
        {
            if (IncludeInDocumentation)
            {
                ...
                if (XYPairs != null)
                {
                    tags.Add(new AutoDocumentation.Paragraph("<i>" + Name + " is calculated as a function of daily min and max temperatures, these are weighted toward VPD at max temperature according to the specified MaximumVPDWeighting factor.  A value equal to 1.0 means it will use VPD at max temperature, a value of 0.5 means average VPD.</i>", indent));
                    tags.Add(new AutoDocumentation.Paragraph("<i>MaximumVPDWeighting = " + MaximumVPDWeighting + "</i>", indent));
