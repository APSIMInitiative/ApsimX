...
module sinks
 ...
 ! and solute while drains are sinks. Here there are two water extraction
 ! streams, one for roots and the other for drippers and drains, and a layer may
 ! not have both drippers and drains. Solute movement is calculated every few
...
contains
 ...
 subroutine ssinks(t,ti,tf,isol,dwexs,c,qsexs,qsexsd)
  ...
  qsexs(idrn,2)=c(idrn)*dwexs(idrn,2)/(tf-ti) ! solute in drainage
  qsexsd(idrn,2)=dwexs(idrn,2)/(tf-ti)
