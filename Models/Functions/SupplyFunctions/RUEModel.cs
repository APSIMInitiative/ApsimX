...
{
    /// <summary>
    /// Biomass fixation (g of plant dry Weight) is modelled as the product of intercepted radiation (MJ) and its conversion efficiency, the radiation use efficiency (RUE, g/MJ) ([Monteith1977]).  
