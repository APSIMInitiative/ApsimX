...
begin
  ...
  begin
      ...
      if (answer = MROK) then
      begin
        ShellExecAsOriginalUser('open', 'https://builds.dotnet.microsoft.com/dotnet/Runtime/8.0.23/dotnet-runtime-10.0.0-win-x64.exe', '', '', SW_SHOWNORMAL, ewNoWait, ErrorCode);
        result := true
      end;
  end;
  if result = true then
