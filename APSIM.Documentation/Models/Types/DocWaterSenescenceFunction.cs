...
namespace APSIM.Documentation.Models.Types
{
    ...
    public class DocWaterSenescenceFunction : DocGeneric
    {
        ...
        public override List<ITag> Document(int none = 0)
        {
            ...
            section.Add(AutoDocumentation.DocumentModel(waterSenFuncModel.FindChild<IModel>("senWaterTimeConst")));
            section.Add(AutoDocumentation.DocumentModel(waterSenFuncModel.FindChild<IModel>("senThreshold")));
