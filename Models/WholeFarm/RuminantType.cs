...
namespace Models.WholeFarm
{
    ...
    public class RuminantType : Model
    {
		...
		///// <summary>
		///// Total grazing hours per day
		///// </summary>
		//[Description("Total grazing hours per day")]
		//public double TotalGrazingHours { get; set; }
		///// <summary>
		///// Grazing hours per day when mixed grazing and cut and carry
		///// </summary>
		//[Description("")]
		//public double MixedGrazingHours { get; set; }
		/// <summary>
		...
		///// <summary>
		///// Fix fodder pool limits
		///// </summary>
		//[Description("Fix fodder pool limits")]
		//public bool FixFodderPoolLimits { get; set; }
		/// <summary>
		...
		public double GestationInterval { get; set; }
		/// <summary>
